package com.kamranyaseen.requestmapping.controller

import com.kamranyaseen.requestmapping.model.Customer
...
class WebController {
	...
	@PostConstruct
    fun initial(){
        custStores.put(1, Customer(1, "Test", "User", 30))
        custStores.put(2, Customer(2, "Sample", "User1", 32))
		custStores.put(2, Customer(3, "Any", "Cust", 25))
    }
